...
public class TopMoviesSimilarUsersStrategy implements  MovieViewStrategy {

    private final GridPane pane;

    private final ObservableList<TopMovie> movies;

    public TopMoviesSimilarUsersStrategy(GridPane pane, ObservableList<TopMovie> movies) {
        this.pane = pane;
        this.movies = movies;
    }
